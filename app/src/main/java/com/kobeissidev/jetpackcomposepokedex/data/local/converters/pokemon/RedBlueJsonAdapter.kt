...
public class RedBlueJsonAdapter(
  moshi: Moshi
) : JsonAdapter<RedBlue>() {
  ...
  @Volatile
  private var constructorRef: Constructor<RedBlue>? = null

  public override fun toString(): String = buildString(29) {
      append("GeneratedJsonAdapter(").append("RedBlue").append(')') }

  public override fun fromJson(reader: JsonReader): RedBlue {
    ...
    if (mask0 == 0xfffffff0.toInt()) {
      ...
      val localConstructor: Constructor<RedBlue> = this.constructorRef ?:
          RedBlue::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: RedBlue?): Unit {
    if (value_ == null) {
