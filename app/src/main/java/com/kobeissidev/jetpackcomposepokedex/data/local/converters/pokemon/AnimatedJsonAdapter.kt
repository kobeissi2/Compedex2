...
public class AnimatedJsonAdapter(
  moshi: Moshi
) : JsonAdapter<Animated>() {
  ...
  @Volatile
  private var constructorRef: Constructor<Animated>? = null

  public override fun toString(): String = buildString(30) {
      append("GeneratedJsonAdapter(").append("Animated").append(')') }

  public override fun fromJson(reader: JsonReader): Animated {
    ...
    if (mask0 == 0xffffff00.toInt()) {
      ...
      val localConstructor: Constructor<Animated> = this.constructorRef ?:
          Animated::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Animated?): Unit {
    if (value_ == null) {
