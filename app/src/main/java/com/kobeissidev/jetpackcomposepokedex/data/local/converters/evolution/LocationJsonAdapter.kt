...
import com.kobeissidev.jetpackcomposepokedex.data.model.evolution.Location
  ...
  public override fun fromJson(reader: JsonReader): Location {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<Location> = this.constructorRef ?:
          Location::class.java.getDeclaredConstructor(String::class.java, String::class.java,
