...
public class CrystalJsonAdapter(
  moshi: Moshi
) : JsonAdapter<Crystal>() {
  ...
  @Volatile
  private var constructorRef: Constructor<Crystal>? = null

  public override fun toString(): String = buildString(29) {
      append("GeneratedJsonAdapter(").append("Crystal").append(')') }

  public override fun fromJson(reader: JsonReader): Crystal {
    ...
    if (mask0 == 0xfffffff0.toInt()) {
      ...
      val localConstructor: Constructor<Crystal> = this.constructorRef ?:
          Crystal::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Crystal?): Unit {
    if (value_ == null) {
