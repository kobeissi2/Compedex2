...
public class UseBeforeJsonAdapter(
  moshi: Moshi
) : JsonAdapter<UseBefore>() {
  ...
  @Volatile
  private var constructorRef: Constructor<UseBefore>? = null

  public override fun toString(): String = buildString(31) {
      append("GeneratedJsonAdapter(").append("UseBefore").append(')') }

  public override fun fromJson(reader: JsonReader): UseBefore {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<UseBefore> = this.constructorRef ?:
          UseBefore::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: UseBefore?): Unit {
    if (value_ == null) {
