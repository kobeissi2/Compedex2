...
public class IconsXJsonAdapter(
  moshi: Moshi
) : JsonAdapter<IconsX>() {
  ...
  @Volatile
  private var constructorRef: Constructor<IconsX>? = null

  public override fun toString(): String = buildString(28) {
      append("GeneratedJsonAdapter(").append("IconsX").append(')') }

  public override fun fromJson(reader: JsonReader): IconsX {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<IconsX> = this.constructorRef ?:
          IconsX::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: IconsX?): Unit {
    if (value_ == null) {
