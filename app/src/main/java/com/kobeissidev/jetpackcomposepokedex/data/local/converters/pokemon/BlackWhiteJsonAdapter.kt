...
public class BlackWhiteJsonAdapter(
  moshi: Moshi
) : JsonAdapter<BlackWhite>() {
  private val options: JsonReader.Options = JsonReader.Options.of("animated", "back_default",
      "back_female", "back_shiny", "back_shiny_female", "front_default", "front_female",
      "front_shiny", "front_shiny_female")

  private val nullableAnimatedAdapter: JsonAdapter<Animated?> = moshi.adapter(Animated::class.java,
      emptySet(), "animated")
  ...
  @Volatile
  private var constructorRef: Constructor<BlackWhite>? = null

  public override fun toString(): String = buildString(32) {
      append("GeneratedJsonAdapter(").append("BlackWhite").append(')') }

  public override fun fromJson(reader: JsonReader): BlackWhite {
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        0 -> {
          animated = nullableAnimatedAdapter.fromJson(reader)
    ...
    if (mask0 == 0xfffffe00.toInt()) {
      ...
      val localConstructor: Constructor<BlackWhite> = this.constructorRef ?:
          BlackWhite::class.java.getDeclaredConstructor(Animated::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: BlackWhite?): Unit {
    if (value_ == null) {
      throw NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.")
    }
    writer.beginObject()
    writer.name("animated")
    nullableAnimatedAdapter.toJson(writer, value_.animated)
