...
public class HeartGoldSoulSilverJsonAdapter(
  moshi: Moshi
) : JsonAdapter<HeartGoldSoulSilver>() {
  ...
  @Volatile
  private var constructorRef: Constructor<HeartGoldSoulSilver>? = null

  public override fun toString(): String = buildString(41) {
      append("GeneratedJsonAdapter(").append("HeartGoldSoulSilver").append(')') }

  public override fun fromJson(reader: JsonReader): HeartGoldSoulSilver {
    ...
    if (mask0 == 0xffffff00.toInt()) {
      ...
      val localConstructor: Constructor<HeartGoldSoulSilver> = this.constructorRef ?:
          HeartGoldSoulSilver::class.java.getDeclaredConstructor(String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: HeartGoldSoulSilver?): Unit {
    if (value_ == null) {
