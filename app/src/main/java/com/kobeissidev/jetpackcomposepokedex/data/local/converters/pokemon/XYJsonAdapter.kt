...
public class XYJsonAdapter(
  ...
  @Volatile
  private var constructorRef: Constructor<XY>? = null

  public override fun toString(): String = buildString(24) {
      append("GeneratedJsonAdapter(").append("XY").append(')') }

  public override fun fromJson(reader: JsonReader): XY {
    ...
    if (mask0 == 0xfffffff0.toInt()) {
      ...
      val localConstructor: Constructor<XY> = this.constructorRef ?:
          XY::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: XY?): Unit {
    if (value_ == null) {
