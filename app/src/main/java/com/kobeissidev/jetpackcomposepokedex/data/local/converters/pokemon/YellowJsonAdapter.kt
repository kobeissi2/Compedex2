...
public class YellowJsonAdapter(
  moshi: Moshi
) : JsonAdapter<Yellow>() {
  ...
  @Volatile
  private var constructorRef: Constructor<Yellow>? = null

  public override fun toString(): String = buildString(28) {
      append("GeneratedJsonAdapter(").append("Yellow").append(')') }

  public override fun fromJson(reader: JsonReader): Yellow {
    ...
    if (mask0 == 0xfffffff0.toInt()) {
      ...
      val localConstructor: Constructor<Yellow> = this.constructorRef ?:
          Yellow::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Yellow?): Unit {
    if (value_ == null) {
