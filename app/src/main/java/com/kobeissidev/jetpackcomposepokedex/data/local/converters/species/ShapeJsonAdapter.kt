...
import com.kobeissidev.jetpackcomposepokedex.data.model.species.Shape
...
public class ShapeJsonAdapter(
  ...
  @Volatile
  private var constructorRef: Constructor<Shape>? = null

  public override fun toString(): String = buildString(27) {
      append("GeneratedJsonAdapter(").append("Shape").append(')') }

  public override fun fromJson(reader: JsonReader): Shape {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<Shape> = this.constructorRef ?:
          Shape::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Shape?): Unit {
    if (value_ == null) {
