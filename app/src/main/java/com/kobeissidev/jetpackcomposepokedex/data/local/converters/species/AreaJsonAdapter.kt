...
public class AreaJsonAdapter(
  ...
  @Volatile
  private var constructorRef: Constructor<Area>? = null

  public override fun toString(): String = buildString(26) {
      append("GeneratedJsonAdapter(").append("Area").append(')') }

  public override fun fromJson(reader: JsonReader): Area {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<Area> = this.constructorRef ?:
          Area::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Area?): Unit {
    if (value_ == null) {
