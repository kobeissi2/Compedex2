...
import com.kobeissidev.jetpackcomposepokedex.data.model.species.Color
...
public class ColorJsonAdapter(
  ...
  @Volatile
  private var constructorRef: Constructor<Color>? = null
  ...
  public override fun fromJson(reader: JsonReader): Color {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<Color> = this.constructorRef ?:
          Color::class.java.getDeclaredConstructor(String::class.java, String::class.java,
