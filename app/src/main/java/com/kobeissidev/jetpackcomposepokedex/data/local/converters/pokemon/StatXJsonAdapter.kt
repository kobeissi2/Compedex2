...
public class StatXJsonAdapter(
  ...
  @Volatile
  private var constructorRef: Constructor<StatX>? = null

  public override fun toString(): String = buildString(27) {
      append("GeneratedJsonAdapter(").append("StatX").append(')') }

  public override fun fromJson(reader: JsonReader): StatX {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<StatX> = this.constructorRef ?:
          StatX::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: StatX?): Unit {
    if (value_ == null) {
