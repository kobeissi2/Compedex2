...
public class TypeXJsonAdapter(
  ...
  @Volatile
  private var constructorRef: Constructor<TypeX>? = null

  public override fun toString(): String = buildString(27) {
      append("GeneratedJsonAdapter(").append("TypeX").append(')') }

  public override fun fromJson(reader: JsonReader): TypeX {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<TypeX> = this.constructorRef ?:
          TypeX::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: TypeX?): Unit {
    if (value_ == null) {
