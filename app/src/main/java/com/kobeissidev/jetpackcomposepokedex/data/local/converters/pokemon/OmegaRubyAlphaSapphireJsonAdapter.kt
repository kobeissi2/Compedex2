...
public class OmegaRubyAlphaSapphireJsonAdapter(
  moshi: Moshi
) : JsonAdapter<OmegaRubyAlphaSapphire>() {
  ...
  @Volatile
  private var constructorRef: Constructor<OmegaRubyAlphaSapphire>? = null

  public override fun toString(): String = buildString(44) {
      append("GeneratedJsonAdapter(").append("OmegaRubyAlphaSapphire").append(')') }

  public override fun fromJson(reader: JsonReader): OmegaRubyAlphaSapphire {
    ...
    if (mask0 == 0xfffffff0.toInt()) {
      ...
      val localConstructor: Constructor<OmegaRubyAlphaSapphire> = this.constructorRef ?:
          OmegaRubyAlphaSapphire::class.java.getDeclaredConstructor(String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: OmegaRubyAlphaSapphire?): Unit {
    if (value_ == null) {
