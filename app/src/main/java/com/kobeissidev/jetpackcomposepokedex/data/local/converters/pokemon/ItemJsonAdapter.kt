...
public class ItemJsonAdapter(
  ...
  @Volatile
  private var constructorRef: Constructor<Item>? = null

  public override fun toString(): String = buildString(26) {
      append("GeneratedJsonAdapter(").append("Item").append(')') }

  public override fun fromJson(reader: JsonReader): Item {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<Item> = this.constructorRef ?:
          Item::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Item?): Unit {
    if (value_ == null) {
