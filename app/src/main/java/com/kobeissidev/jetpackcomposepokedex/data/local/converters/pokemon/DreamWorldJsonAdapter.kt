...
public class DreamWorldJsonAdapter(
  moshi: Moshi
) : JsonAdapter<DreamWorld>() {
  ...
  @Volatile
  private var constructorRef: Constructor<DreamWorld>? = null

  public override fun toString(): String = buildString(32) {
      append("GeneratedJsonAdapter(").append("DreamWorld").append(')') }

  public override fun fromJson(reader: JsonReader): DreamWorld {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<DreamWorld> = this.constructorRef ?:
          DreamWorld::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: DreamWorld?): Unit {
    if (value_ == null) {
