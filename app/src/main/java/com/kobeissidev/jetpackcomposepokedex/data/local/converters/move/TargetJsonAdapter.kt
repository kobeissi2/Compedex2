...
public class TargetJsonAdapter(
  moshi: Moshi
) : JsonAdapter<Target>() {
  ...
  @Volatile
  private var constructorRef: Constructor<Target>? = null

  public override fun toString(): String = buildString(28) {
      append("GeneratedJsonAdapter(").append("Target").append(')') }

  public override fun fromJson(reader: JsonReader): Target {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<Target> = this.constructorRef ?:
          Target::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Target?): Unit {
    if (value_ == null) {
