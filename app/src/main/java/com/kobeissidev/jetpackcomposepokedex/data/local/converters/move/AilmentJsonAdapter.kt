...
public class AilmentJsonAdapter(
  moshi: Moshi
) : JsonAdapter<Ailment>() {
  ...
  @Volatile
  private var constructorRef: Constructor<Ailment>? = null

  public override fun toString(): String = buildString(29) {
      append("GeneratedJsonAdapter(").append("Ailment").append(')') }

  public override fun fromJson(reader: JsonReader): Ailment {
    ...
    if (mask0 == 0xfffffffc.toInt()) {
      ...
      val localConstructor: Constructor<Ailment> = this.constructorRef ?:
          Ailment::class.java.getDeclaredConstructor(String::class.java, String::class.java,
  ...
  public override fun toJson(writer: JsonWriter, value_: Ailment?): Unit {
    if (value_ == null) {
